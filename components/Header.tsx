...
import { CloudHeartIcon, UserIcon, LogoutIcon } from './icons';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex md:items-center md:space-x-8">
            ...
            {currentUser && <NavLink to="/dashboard" className="text-gray-600 hover:text-brand-primary transition-colors">Minha Conta</NavLink>}
          </nav>
              ...
              <div className="relative">
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                    ...
                    <button onClick={() => { logout(); setMenuOpen(false); }} className="w-full text-left flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
