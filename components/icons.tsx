...
export const CloudHeartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17.5 19H9.5a7 7 0 0 1-7-7 7 7 0 0 1 7-7h.5a4.5 4.5 0 0 1 4.2 3.1c.4-.1.8-.1 1.3-.1a5 5 0 0 1 5 5c0 .9-.2 1.7-.6 2.4" />
    <path d="M16 22a2.4 2.4 0 0 0 3-2.5 2.4 2.4 0 0 0-3-2.5c-.3 0-.5.2-.7.3" />
  </svg>
);
...
export const WithdrawIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="3" y="8" width="18" height="11" rx="2" ry="2"></rect><path d="M7 8V6a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v2"></path><path d="M12 14v-1"></path><path d="M12 12a1.5 1.5 0 0 0-1.5 1.5h3A1.5 1.5 0 0 0 12 12Z"></path>
    </svg>
);
export const CampaignsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MadeDonationIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
       <path d="M12 12V3"></path><path d="m9 6 3-3 3 3"></path><path d="M15 12h3.5a2.5 2.5 0 1 1 0 5h-11a2.5 2.5 0 1 1 0-5H9"></path><path d="M3 21h18"></path>
    </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.9 2.1c.2-.3.5-.4.8-.4s.6.1.8.4l1.2 2.1c.2.3.5.6.9.7l2.3.4c.4.1.7.3.9.7s.1.8-.1 1.1l-1.7 1.7c-.3.2-.4.6-.3.9l.4 2.3c.1.4 0 .8-.3 1s-.7.4-1.1.2l-2.1-1.1c-.3-.2-.7-.2-1 0l-2.1 1.1c-.4.2-.8.1-1.1-.2s-.4-.7-.3-1l.4-2.3c.1-.3 0-.7-.3-.9l-1.7-1.7c-.3-.3-.3-.7-.1-1.1s.5-.6.9-.7l2.3-.4c.3 0 .6-.3.9-.7l1.2-2.1z" /><path d="M18 13.5c.2-.3.5-.4.8-.4s.6.1.8.4l.6 1.1c.2.3.5.6.9.7l1.2.2c.4.1.7.3.9.7s.1.8-.1 1.1l-.9.9c-.3.2-.4.6-.3.9l.2 1.2c.1.4 0 .8-.3 1s-.7.4-1.1.2l-1.1-.6c-.3-.2-.7-.2-1 0l-1.1.6c-.4.2-.8.1-1.1-.2s-.4-.7-.3-1l.2-1.2c.1-.3 0-.7-.3-.9l-.9-.9c-.3-.3-.3-.7-.1-1.1s.5-.6.9-.7l1.2-.2c.3 0 .6-.3.9-.7l.6-1.1z" />
    </svg>
);
...
export const PaletteIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10"></circle><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path><circle cx="12" cy="12" r="3"></circle>
    </svg>
);
