...
const AdminDonationsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const mockDonations: Donation[] = [
            ...
            {
                id: 'd2
Vou continuar a criação da página de controle financeiro:

<dyad-write path="pages/AdminDonationsPage.tsx" description="Creating donations management page with financial control">
import React, { useState, useEffect } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { CloudHeartIcon, FinancialIcon, DownloadIcon, SearchIcon, CalendarIcon, DollarSignIcon, CreditCardIcon, BarcodeIcon } from '../components/icons';
